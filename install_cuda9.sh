...
sudo bash ./cuda_9.0.176_384.81_linux-run -override --silent -toolkit -driver
...
sudo bash ./cuda_9.0.176.1_linux-run --silent -accept-eula
...
sudo bash ./cuda_9.0.176.2_linux-run --silent -accept-eula
...
sudo bash ./cuda_9.0.176.4_linux-run --silent -accept-eula
